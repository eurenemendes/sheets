...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loadData();
    // Poll every 60 seconds to "re-use data as it updates"
  ...
  return (
    <div className="min-h-screen pb-20">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Live Sheet Data Visualization</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
              <div className="relative w-full sm:w-64">
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-100 border-none rounded-xl focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all outline-none"
                  value={searchTerm}
              ...
              <select 
                className="w-full sm:w-auto px-4 py-2 bg-gray-100 rounded-xl border-none text-gray-600 font-medium focus:ring-2 focus:ring-indigo-500 outline-none"
                value={sortBy}
      ...
      {/* Footer Info */}
      <footer className="mt-20 border-t border-gray-100 pt-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
            <p className="text-gray-400 text-sm">
                Atualizado em tempo real via Google Sheets API.
            </p>
            <p className="text-gray-300 text-[10px] mt-2 font-mono">
                GID: 2050396937 • Powered by Gemini AI
            </p>
        </div>
      </footer>
    </div>
